...
namespace Dollie\SDK\Integrations\AdvancedCoupons\Actions;
...
#[Action(
    id: 'remove_store_credit_from_user',
    label: 'Remove Store Credit from User',
    since: '1.0.0'
)]
/**
...
class RemoveStoreCreditFromUser extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Remove Store Credit from User', 'dollie'),
            'action' => $this->action,
