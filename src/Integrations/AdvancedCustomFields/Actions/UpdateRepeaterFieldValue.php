...
namespace Dollie\SDK\Integrations\AdvancedCustomFields\Actions;
...
#[Action(
    id: 'update_repeater_field_acf_value',
    label: 'Update Repeater Field Value',
    since: '1.0.0'
)]
...
class UpdateRepeaterFieldValue extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Update Repeater Field Value', 'dollie'),
            'action' => $this->action,
