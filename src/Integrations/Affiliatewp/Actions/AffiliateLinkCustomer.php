...
namespace Dollie\SDK\Integrations\Affiliatewp\Actions;
...
#[Action(
    id: 'affiliate_link_customer',
    label: 'Link Customer to an Affiliate for Lifetime Commissions',
    since: '1.0.0'
)]
/**
...
class AffiliateLinkCustomer extends AutomateAction {
	...
	public function register( $actions ) {
		$actions[ $this->integration ][ $this->action ] = [
			'label'    => __( 'Link Customer to an Affiliate for Lifetime Commissions', 'dollie' ),
			'action'   => $this->action,
