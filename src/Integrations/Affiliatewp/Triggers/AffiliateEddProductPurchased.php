...
#[Trigger(
    id: 'affiliate_edd_product_purchased',
    label: 'Affiliate Refers a sale of Easy Digital Downloads Product',
    since: '1.0.0'
)]
/**
...
class AffiliateEddProductPurchased
{
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('Affiliate Refers a sale of Easy Digital Downloads Product', 'dollie'),
            'action' => $this->trigger,
