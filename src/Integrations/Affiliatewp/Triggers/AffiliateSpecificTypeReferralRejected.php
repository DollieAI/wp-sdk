...
#[Trigger(
    id: 'affiliate_specific_type_referral_rejected',
    label: 'Affiliate Referral of Specific Type Rejected',
    since: '1.0.0'
)]
/**
...
class AffiliateSpecificTypeReferralRejected
{
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('Affiliate Referral of Specific Type Rejected', 'dollie'),
            'action' => $this->trigger,
