...
namespace Dollie\SDK\Integrations\Amelia\Triggers;
...
#[Trigger(
    id: 'amelia_appointment_booking_status_changed',
    label: 'Appointment Booking Status Changed',
    since: '1.0.0'
)]
/**
...
class AppointmentBookingStatusChanged
{
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('Appointment Booking Status Changed', 'dollie'),
            'action' => $this->trigger,
