...
namespace Dollie\SDK\Integrations\Badgeos\Actions;
...
#[Action(
    id: 'award_achievement_to_user',
    label: 'Award a Achievement to the user',
    since: '1.0.0'
)]
/**
...
class AwardAchievementToUser extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Award a Achievement to the user', 'dollie'),
            'action' => $this->action,
