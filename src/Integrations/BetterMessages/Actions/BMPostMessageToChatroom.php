...
namespace Dollie\SDK\Integrations\BetterMessages\Actions;
...
#[Action(
    id: 'bm_post_message_to_chatroom',
    label: 'Post Message to Chatroom',
    since: '1.0.0'
)]
/**
...
class BMPostMessageToChatroom extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Post Message to Chatroom', 'dollie'),
            'action' => $this->action,
