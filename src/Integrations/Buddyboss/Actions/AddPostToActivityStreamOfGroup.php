...
use Dollie\SDK\Integrations\BuddyBoss\BuddyBoss;
use Dollie\SDK\Traits\SingletonLoader;
use Exception;

#[Action(
    id: 'bb_add_post_to_activity_stream_of_group',
    label: 'Add post to activity stream of group',
    since: '1.0.0'
)]
/**
...
class AddPostToActivityStreamOfGroup extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Add post to activity stream of group', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        ! function_exists('bp_activity_add')) {
            return [
                'status' => 'error',
                'message' => __('BuddyBoss Groups activity functions not found.', 'dollie'),
            ];
        }
