...
#[Action(
    id: 'bb_change_user_member_type',
    label: 'Change Member Profile Type',
    since: '1.0.0'
)]
/**
...
class ChangeUserMemberType extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Change Member Profile Type', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! function_exists('bp_set_member_type')) {
            return [
                'status' => 'error',
                'message' => __('bp_set_member_type function not found.', 'dollie'),
            ];
        }
