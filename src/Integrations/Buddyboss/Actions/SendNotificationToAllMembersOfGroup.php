...
#[Action(
    id: 'bb_send_notification_to_all_members_of_group',
    label: 'Send Notification To All Members Of Group',
    since: '1.0.0'
)]
/**
...
class SendNotificationToAllMembersOfGroup extends AutomateAction
{
    ...
    public function st_bdb_component($component_names, $active_components)
    {
        ...
        array_push($component_names, 'dollie');
    ...
    public function register($actions)
    {
        ...
        $actions[$this->integration][$this->action] = [
            'label' => __('Send Notification To All Members Of Group', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        if (! function_exists('bp_core_current_time') || ! function_exists('bp_notifications_update_meta')) {
            return [
                'status' => 'error',
                'message' => __('BuddyBoss core functions not found.', 'dollie'),
            ];
        }
