...
#[Action(
    id: 'bb_set_user_extended_profile',
    label: 'Set User Extended Profile',
    since: '1.0.0'
)]
/**
...
class SetUserExtendedProfile extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Set User Extended Profile', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! function_exists('xprofile_set_field_data')) {
            return [
                'status' => 'error',
                'message' => __('xprofile_set_field_data function not found.', 'dollie'),
            ];
        }
