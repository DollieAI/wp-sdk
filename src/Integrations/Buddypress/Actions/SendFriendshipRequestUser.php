...
#[Action(
    id: 'send_friendship_request_user',
    label: 'Send a friendship request to a user',
    since: '1.0.0'
)]
/**
...
class SendFriendshipRequestUser extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Send a friendship request to a user', 'dollie'),
            'action' => $this->action,
            ...
            if ($sender_user) {
                if ($user) {
                    ...
                    if (function_exists('friends_add_friend')) {
                        ...
                        return [
                            'status' => 'error',
                            'message' => 'BuddyPress connection module is not active.',
                        ];
                    }
                } else {
                    return [
