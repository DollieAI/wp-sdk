...
class CreateLink extends AutomateAction
{
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (empty($title)) {
            return [
                'status' => 'error',
                'message' => __('Title is required to create a link.', 'dollie'),
        ...
        if (empty($url)) {
            return [
                'status' => 'error',
                'message' => __('URL is required to create a link.', 'dollie'),
        ...
        if (false === $result) {
            return [
                'status' => 'error',
                'message' => __('Failed to create link in ClickWhale.', 'dollie'),
