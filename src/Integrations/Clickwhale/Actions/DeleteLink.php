...
class DeleteLink extends AutomateAction
{
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (empty($link_id)) {
            return [
                'status' => 'error',
                'message' => __('Link ID is required to delete a link.', 'dollie'),
        ...
        if (! $link) {
            return [
                'status' => 'error',
                'message' => __('Link not found.', 'dollie'),
        ...
        if (false === $result) {
            return [
                'status' => 'error',
                'message' => __('Failed to delete link from ClickWhale.', 'dollie'),
