...
namespace Dollie\SDK\Integrations\Clickwhale\Actions;
...
class UpdateLink extends AutomateAction
{
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (empty($link_id)) {
            return [
                'status' => 'error',
                'message' => __('Link ID is required to update a link.', 'dollie'),
        ...
        if (empty($update_data)) {
            return [
                'status' => 'error',
                'message' => __('At least one field is required to update the link.', 'dollie'),
        ...
        if (false === $result) {
            return [
                'status' => 'error',
                'message' => __('Failed to update link in ClickWhale.', 'dollie'),
        ...
        if (! $link) {
            return [
                'status' => 'error',
                'message' => __('Link not found after update.', 'dollie'),
