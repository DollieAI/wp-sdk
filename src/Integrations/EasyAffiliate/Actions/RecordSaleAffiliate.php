...
namespace Dollie\SDK\Integrations\EasyAffiliate\Actions;
...
#[Action(
    id: 'ea_record_sale_affiliate',
    label: 'Record Sale for Affiliate',
    since: '1.0.0'
)]
/**
 * RecordSaleAffiliate.
...
class RecordSaleAffiliate extends AutomateAction
{
    ...
    public function register($actions)
    {
        ...
        $actions[$this->integration][$this->action] = [
            'label' => __('Record Sale for Affiliate', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! class_exists('EasyAffiliate\Models\Transaction')) {
            return [
                'status' => 'error',
                'message' => __('EasyAffiliate\Models\Transaction class not found.', 'dollie'),
