...
#[Action(
    id: 'find_user_have_active_or_inactive_license_for_specific_download',
    label: 'User have subscription for download',
    since: '1.0.0'
)]
/**
...
class FindIfUserHasActiveInactiveLicenseDownload extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('User have subscription for download', 'dollie'),
            'action' => $this->action,
