...
namespace Dollie\SDK\Integrations\Edd;
 ...
 * @since 1.0.0
 */
class EDD extends BaseIntegration
{
    use SingletonLoader;
    ...
    {
        $this->name = __('EDD', 'dollie');
        $this->description = __('Easy Digital Downloads is a complete eCommerce solution for selling digital products on WordPress.', 'dollie');
        $this->icon_url = DOLLIE_SDK_URL . 'assets/icons/edd.svg';
     ...
     * @param  int|null            $download_id download id.
     * @return array
     */
     ...
     * @param  int $download_id Downoad ID.
