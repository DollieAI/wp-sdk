...
#[Trigger(
    id: 'user_submits_specific_field_value_fluentform',
    label: 'User Submits Form with Specific Field Value',
    since: '1.0.0'
)]
/**
...
class UserSubmitsSpecificFieldValueFluentForm
{
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('User Submits Form with Specific Field Value', 'dollie'),
