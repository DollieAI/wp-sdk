...
#[Action(
    id: 'fluentcrm_add_email_to_sequence',
...
class AddEmailToSequence extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Add Email to Sequence', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! class_exists('\FluentCampaign\App\Models\Sequence') || ! class_exists('\FluentCampaign\App\Models\SequenceMail')) {
            return [
                'status' => 'error',
                'message' => __('FluentCampaign Pro is not installed or activated.', 'dollie'),
        ...
        if (! $sequence_id) {
            return [
                'status' => 'error',
                'message' => __('Sequence ID is required.', 'dollie'),
        ...
        if (! $sequence) {
            return [
                'status' => 'error',
                'message' => __('Sequence not found.', 'dollie'),
        ...
        if (! $sequence_email) {
            return [
                'status' => 'error',
                'message' => __('Failed to add email to sequence.', 'dollie'),
