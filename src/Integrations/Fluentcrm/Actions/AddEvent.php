...
class AddEvent extends AutomateAction
{
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        if (! function_exists('FluentCrmApi')) {
            return [
                'status' => 'error',
                'message' => __('FluentCRM API is not active.', 'dollie'),
        ...
        if (empty($selected_options['email']) || empty($selected_options['event_key']) || empty($selected_options['title'])) {
            return [
                'success' => false,
                'message' => __('Email, Event Key, and Title are required.', 'dollie'),
        ...
        if (! $result) {
            return [
                'success' => false,
                'message' => __('Failed to add event. Please try again.', 'dollie'),
        ...
        return [
            'success' => true,
            'message' => __('Event has been successfully added.', 'dollie'),
            'event' => $result,
        ];
    }
}
