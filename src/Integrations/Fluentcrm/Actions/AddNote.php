...
class AddNote extends AutomateAction
{
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (is_null($contact)) {
            return [
                'message' => __('Can not find the contact with the email.', 'dollie'),
                'status' => 'false',
                'user_exists' => 'false',
            ];
        }
        ...
        if (! $subscriber_note) {
            return [
                'success' => false,
                'message' => __('Failed to add note. Please try again.', 'dollie'),
        ...
        return [
            'success' => true,
            'message' => __('Note has been successfully added.', 'dollie'),
