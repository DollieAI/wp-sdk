...
#[Action(
    id: 'fluentcrm_attach_subscribers_company',
    label: 'Attach Subscribers to Company',
    since: '1.0.0'
)]
/**
...
class AttachSubscribersCompany extends AutomateAction
{
    ...
    public function register($actions)
    {
        ...
        $actions[$this->integration][$this->action] = [
            'label' => __('Attach Subscribers to Company', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! $result) {
            return [
                'status' => 'error',
                'message' => __('Invalid data', 'dollie'),

            ];
        }

        return [
            'message' => __('Company has been successfully attached to the Subscribers', 'dollie'),
