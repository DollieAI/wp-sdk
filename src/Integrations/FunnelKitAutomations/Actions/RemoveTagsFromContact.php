...
#[Action(
    id: 'funnel_kit_automations_remove_tags_from_contact',
    label: 'Remove Tag(s) from Contact',
    since: '1.0.0'
)]
/**
...
class RemoveTagsFromContact extends AutomateAction
{
    ...
    public function register($actions)
    {
        ...
        $actions[$this->integration][$this->action] = [
            'label' => __('Remove Tag(s) from Contact', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if ($bwfcm_contact->contact->get_id() === 0) {
            return [
                'status' => 'error',
                'message' => 'Contact not exists with this email.',
            ];
        }
