...
namespace Dollie\SDK\Integrations\GeoDirectory\Actions;

use Dollie\SDK\Attributes\Action;
use Dollie\SDK\Integrations\AutomateAction;
use Dollie\SDK\Integrations\GeoDirectory\GeoDirectory;
use Dollie\SDK\Traits\SingletonLoader;
use Exception;

#[Action(
    id: 'remove_category_from_place',
    label: 'Remove Category From Place',
    since: '1.0.0'
)]
/**
...
class RemoveCategoryFromPlace extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Remove Category From Place', 'dollie'),
            'action' => $this->action,
