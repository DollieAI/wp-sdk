...
#[Trigger(
    id: 'geodir_claim_rejected',
    label: 'Listing Claim Rejected',
    since: '1.0.0'
)]
/**
 * ClaimRejected
...
class ClaimRejected
{
     ...
     * @var string
     */
    public $trigger = 'geodir_claim_rejected';
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('Listing Claim Rejected', 'dollie'),
            'action' => $this->trigger,
            'common_action' => 'geodir_claim_rejected',
