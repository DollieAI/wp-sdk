...
namespace Dollie\SDK\Integrations\GeoDirectory\Triggers;
...
#[Trigger(
    id: 'geodir_claimed_listing_added',
    label: 'New Listing Claim Submitted',
    since: '1.0.0'
)]
/**
 * ClaimedListingAdded
 ...
 * ClaimedListingAdded
 *
 * @category ClaimedListingAdded
 * @author   BSF <username@example.com>
 * @license  https://www.gnu.org/licenses/gpl-3.0.html GPLv3
 * @link     https://www.brainstormforce.com/
 * @since    1.0.0
 */
class ClaimedListingAdded
{
    use SingletonLoader;
     ...
     * @var string
     */
    public $trigger = 'geodir_claimed_listing_added';
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('New Listing Claim Submitted', 'dollie'),
            'action' => $this->trigger,
            'common_action' => 'geodir_claim_post_item_inserted',
     ...
     * @return void
     */
    public function trigger_listener($claim_id)
    {
        if (empty($claim_id)) {
            return;
        }
        ...
        $claim = null;
        if (class_exists('GeoDir_Claim_Post')) {
...
ClaimedListingAdded::get_instance();
