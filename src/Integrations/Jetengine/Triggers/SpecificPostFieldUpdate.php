...
namespace Dollie\SDK\Integrations\Jetengine\Triggers;
...
#[Trigger(
    id: 'specific_post_field_update',
    label: 'A user updates a specific JetEngine field on a specific post type',
    since: '1.0.0'
)]
/**
...
class SpecificPostFieldUpdate
{
    ...
    public function register($triggers)
    {
        ...
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('A user updates a specific JetEngine field on a specific post type', 'dollie'),
            'action' => $this->trigger,
