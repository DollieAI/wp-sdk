...
namespace Dollie\SDK\Integrations\JetpackCRM;
 ...
 * @since 1.0.0
 */
class JetpackCRM extends BaseIntegration
{
    use SingletonLoader;
    ...
    {
        $this->name = __('JetpackCRM', 'dollie');
        $this->description = __('JetpackCRM is a WordPress Customer Support plugin.', 'dollie');
