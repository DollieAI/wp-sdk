...
namespace Dollie\SDK\Integrations\LatePoint;
 ...
 * @since 1.0.0
 */
class LatePoint extends BaseIntegration
{
    use SingletonLoader;
    ...
    {
        $this->name = __('LatePoint', 'dollie');
        $this->description = __('Appointment Scheduling Plugin for WordPress.', 'dollie');
        $this->icon_url = DOLLIE_SDK_URL . 'assets/icons/late-point.svg';
