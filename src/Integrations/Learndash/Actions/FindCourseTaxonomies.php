...
#[Action(
    id: 'ld_find_course_taxonomies',
    label: 'Find Course Taxonomies',
    since: '1.0.0'
)]
/**
...
class FindCourseTaxonomies extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Find Course Taxonomies', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (empty($course_id) || get_post_type($course_id) !== 'sfwd-courses') {
            return [
                'message' => __('Invalid Course ID.', 'dollie'),
        ...
        return [
            'course_id' => $course_id,
            'taxonomies' => ! empty($course_taxonomies) ? $course_taxonomies : __('No taxonomies found.', 'dollie'),
