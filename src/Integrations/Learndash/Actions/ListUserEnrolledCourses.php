...
#[Action(
    id: 'ld_list_user_enrolled_courses',
    label: 'List User Enrolled Courses',
    since: '1.0.0'
)]
/**
...
class ListUserEnrolledCourses extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('List User Enrolled Courses', 'dollie'),
            'action' => $this->action,
            ...
            if ($user) {
                ...
                if (! empty($courses)) {
                    ...
                    $message = [
                        ...
                        'response' => esc_attr__('No Enrolled Courses found for this User.', 'dollie'),
