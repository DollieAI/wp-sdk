...
namespace Dollie\SDK\Integrations\Lifterlms;
...
class LifterLMS extends BaseIntegration
{
    ...
    {
        $this->name = __('LifterLMS', 'dollie');
        $this->description = __('Easily Create And Sell Online Courses On Your WP Site With LifterLMS.', 'dollie');
        $this->icon_url = DOLLIE_SDK_URL . 'assets/icons/lifterlms.svg';
