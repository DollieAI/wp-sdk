...
class MarkCourseCompleteForUser extends AutomateAction {
	...
	public function register( $actions ) {
		$actions[ $this->integration ][ $this->action ] = [
			'label'    => __( 'Mark a course complete for the user', 'dollie' ),
			'action'   => $this->action,
	...
	public function _action_listener( $user_id, $automation_id, $fields, $selected_options ) {
		...
		if ( ! empty( $curriculum_arr ) ) {
			...
			$response = [
				...
				'response' => esc_attr__( 'Course marked as completed successfully.', 'dollie' ), 
			...
			$error = [
				...
				'response' => esc_attr__( 'Course does not have any lessons or quizzes added.', 'dollie' ), 
