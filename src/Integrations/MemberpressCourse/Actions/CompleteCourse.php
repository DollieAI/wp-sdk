...
namespace Dollie\SDK\Integrations\MemberPressCourse\Actions;

use Dollie\SDK\Attributes\Action;
use Dollie\SDK\Integrations\AutomateAction;
use Dollie\SDK\Integrations\MemberPressCourse\MemberPressCourse;
...
class CompleteCourse extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Complete Course', 'dollie'),
            'action' => $this->action,
    ...
    public function mark_lesson_completed($user_id, $course_id, $lesson_id, $section)
    {
        if (! class_exists('\memberpress\courses\models\UserProgress')) {
            return [
                'status' => 'error',
                'message' => __('\memberpress\courses\models\UserProgress class not found.', 'dollie'),
    ...
    public function find_all_by_section($section_id)
    {
        if (! class_exists('\memberpress\courses\models\Lesson')) {
            return [
                'status' => 'error',
                'message' => __('\memberpress\courses\models\Lesson class not found.', 'dollie'),
