...
class GetObjectFields extends AutomateAction {
	...
	public function register( $actions ) {
		$actions[ $this->integration ][ $this->action ] = [
			'label'    => __( 'Get Object Fields', 'dollie' ),
			'action'   => $this->action,
	...
	public function _action_listener( $user_id, $automation_id, $fields, $selected_options ) {
		...
		if ( function_exists( 'rwmb_get_object_fields' ) ) {
			...
			[
				...
				'message' => esc_attr__( 'Function rwmb_get_object_fields not exists. Please make sure the Metabox plugin is installed and active.', 'dollie' ), 
