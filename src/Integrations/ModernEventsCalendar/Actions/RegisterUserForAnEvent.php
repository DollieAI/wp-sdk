...
namespace Dollie\SDK\Integrations\ModernEventsCalendar\Actions;
...
#[Action(
    id: 'mec_register_user_for_an_event',
    label: 'Register User for an Event',
    since: '1.0.0'
)]
/**
...
class RegisterUserForAnEvent extends AutomateAction
{
    ...
    public function register($actions)
    {
        ...
        $actions[$this->integration][$this->action] = [
            'label' => __('Register User for an Event', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! class_exists('\MEC_gateway_pay_locally')) {
            return [
                'status' => 'error',
                'message' => __('\MEC_gateway_pay_locally class not found.', 'dollie'),
        ...
        if (! class_exists('\MEC_feature_books')) {
            return [
                'status' => 'error',
                'message' => __('\MEC_feature_books class not found.', 'dollie'),
