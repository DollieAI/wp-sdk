...
namespace Dollie\SDK\Integrations\ModernEventsCalendar;
...
#[Integration(
    id: 'ModernEventsCalendar',
    name: 'ModernEventsCalendar',
 ...
 * @since 1.0.0
 */
class ModernEventsCalendar extends BaseIntegration
{
    use SingletonLoader;
    ...
    {
        $this->name = __('Modern Events Calendar', 'dollie');
        $this->description = __('Best WordPress Event Calendar Plugin.', 'dollie');
        $this->icon_url = DOLLIE_SDK_URL . 'assets/icons/moderneventscalendar.svg';
