...
namespace Dollie\SDK\Integrations\Newsletter\Triggers;
...
#[Trigger(
    id: 'subscription_form_submitted_list',
    label: 'Subscription Form Submitted with Specific List',
    since: '1.0.0'
)]
/**
...
class SubscriptionFormSubmittedList
{
    ...
    public function register($triggers)
    {
        ...
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('Subscription Form Submitted with Specific List', 'dollie'),
            'action' => $this->trigger,
