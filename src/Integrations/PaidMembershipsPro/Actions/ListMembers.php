...
#[Action(
    id: 'list_members_by_membership_level',
    label: 'List all users in a membership level',
    since: '1.0.0'
)]
/**
 * ListMembers.
...
class ListMembers extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('List all users in a membership level', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (empty($results)) {
            return [
                ...
                'response' => esc_attr__('No active members found for the selected level.', 'dollie'),
