...
#[Action(
    id: 'add_update_profilepress_customer',
    label: 'Add/Update ProfilePress customer',
    since: '1.0.0'
)]
/**
...
class AddUpdateProfilepressCustomer extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Add/Update ProfilePress customer', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! is_wp_error($user_id)) {
            ...
            if (class_exists('ProfilePress\Core\Membership\Models\Customer\CustomerFactory')) {
                ...
                if (! $customer->exists()) {
                    if (class_exists('ProfilePress\Core\Membership\Models\Customer\CustomerEntity')) {
                        ...
                        if (empty($customer_id)) {
                            return [
                                ...
                                'response' => __('Error creating customer record.', 'dollie'),
                            ...
                            return [
                                ...
                                'response' => __('Customer successfully created and linked to user.', 'dollie'),
                    ...
                    return [
                        'status' => __('Success', 'dollie'),
                        'response' => __('Customer successfully updated.', 'dollie'),
        ...
        return [
            'status' => __('Error', 'dollie'),
            'response' => __('No customer has been created or updated', 'dollie'),
