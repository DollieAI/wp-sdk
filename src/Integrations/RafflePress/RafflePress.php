...
namespace Dollie\SDK\Integrations\RafflePress;
 ...
 * @since 1.0.0
 */
class RafflePress extends BaseIntegration
{
    use SingletonLoader;
    ...
    {
        $this->name = __('RafflePress', 'dollie');
        $this->description = __('Best WordPress Giveaway and Contest Plugin.', 'dollie');
        $this->icon_url = DOLLIE_SDK_URL . 'assets/icons/rafflepress.svg';
