...
namespace Dollie\SDK\Integrations\RestrictContent\Actions;
...
#[Action(
    id: 'restrict_content_remove_user',
    label: 'Remove User from Membership Level',
    since: '1.0.0'
)]
/**
...
class RestrictContentRemoveUser extends AutomateAction
{
    ...
    public function register($actions)
    {
        ...
        $actions[$this->integration][$this->action] = [
            'label' => __('Remove User from Membership Level', 'dollie'),
            'action' => $this->action,
