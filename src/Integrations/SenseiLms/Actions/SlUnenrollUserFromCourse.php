...
namespace Dollie\SDK\Integrations\SenseiLMS\Actions;
...
#[Action(
    id: 'sl_unenroll_user_from_course',
...
class SlUnenrollUserFromCourse extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Unenroll User From Course', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (is_email($user_email)) {
            ...
            if ($user) {
                ...
                $error = [
                    ...
                    'response' => esc_attr__('User not found with specified email address.', 'dollie'),
        ...
        $response = [
            ...
            'response' => esc_attr__('User unenrolled successfully', 'dollie'),
