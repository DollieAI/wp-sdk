...
namespace Dollie\SDK\Integrations\SliceWP\Actions;
...
#[Action(
    id: 'slicewp_create_commission',
    label: 'Create Commission for specific Affiliate',
    since: '1.0.0'
)]
/**
...
class SliceWPCreateCommission extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Create Commission for specific Affiliate', 'dollie'),
            'action' => $this->action,
