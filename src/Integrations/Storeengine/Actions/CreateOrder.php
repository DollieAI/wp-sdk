...
class CreateOrder extends AutomateAction
{
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! class_exists('\\StoreEngine\\Classes\\Order')) {
            return [
                'status' => 'error',
                'message' => __('StoreEngine Order class not found. Please ensure StoreEngine is properly installed.', 'dollie'),
        ...
        if (! $order->get_id()) {
            return [
                'status' => 'error',
                'message' => __('Failed to create the order.', 'dollie'),
