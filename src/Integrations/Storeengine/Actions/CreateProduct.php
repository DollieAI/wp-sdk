...
namespace Dollie\SDK\Integrations\Storeengine\Actions;
...
class CreateProduct extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Create Product', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! class_exists('StoreEngine')) {
            return [
                'status' => 'error',
                'message' => __('StoreEngine plugin is not active.', 'dollie'),
        ...
        if (empty($product_name)) {
            return [
                'status' => 'error',
                'message' => __('Product name is required.', 'dollie'),
        ...
        if (is_wp_error($product_id)) {
            return [
                'status' => 'error',
                'message' => sprintf(
                    __('Failed to create product: %s', 'dollie'),
        ...
        if (! $product_id || ! is_numeric($product_id)) {
            return [
                'status' => 'error',
                'message' => __('Failed to create product: Invalid product ID returned', 'dollie'),
        ...
        if (! $product) {
            return [
                'status' => 'error',
                'message' => __('Failed to retrieve created product.', 'dollie'),
