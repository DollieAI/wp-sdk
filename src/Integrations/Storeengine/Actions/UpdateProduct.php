...
class UpdateProduct extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Update Product', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (is_wp_error($updated_product_id)) {
            return [
                'status' => 'error',
                'message' => sprintf(
                    __('Failed to update product: %s', 'dollie'),
        ...
        if (! $updated_product_id || ! is_numeric($updated_product_id)) {
            return [
                'status' => 'error',
                'message' => __('Failed to update product: Invalid product ID returned', 'dollie'),
        ...
        if (! $updated_product) {
            return [
                'status' => 'error',
                'message' => __('Failed to retrieve updated product.', 'dollie'),
