...
namespace Dollie\SDK\Integrations\Triggerbutton\Triggers;
...
#[Trigger(
    id: 'st_trigger_button',
    label: 'A User Clicks on Trigger Button',
    since: '1.0.0'
)]
/**
...
class UserClicksOnTriggerButton
{
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('A User Clicks on Trigger Button', 'dollie'),
            'action' => $this->trigger,
    ...
    public function trigger_listener($st_trigger_id, $user_id, $cookie_duration, $setcookie, $parent_post_data)
    {
        ...
        $automation = AutomationController::dollie_trigger_handle_trigger(
            [
