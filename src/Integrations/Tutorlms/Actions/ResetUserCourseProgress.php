...
#[Action(
    id: 'tlms_reset_user_course_progress',
    label: 'Reset User Course Progress',
    since: '1.0.0'
)]
/**
...
class ResetUserCourseProgress extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Reset User Course Progress', 'dollie'),
            'action' => $this->action,
        ...
        if (is_email($user_email)) {
            ...
            if ($user) {
                ...
                $response = [
                    ...
                    'response' => esc_attr__('User course progress has been successfully reset.', 'dollie'),
