...
#[Action(
    id: 'voxel_add_post_profile_wall',
    label: 'Add Post to Profile Wall',
    since: '1.0.0'
)]
/**
 * AddPostProfileWall.
...
class AddPostProfileWall extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Add Post to Profile Wall', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        return [
            'success' => true,
            'message' => esc_attr__("Post added to user's profile wall successfully", 'dollie'),
