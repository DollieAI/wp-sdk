...
#[Action(
    id: 'voxel_add_post_to_collection',
    label: 'Add Post to Collection',
    since: '1.0.0'
)]
/**
 * AddPostToCollection.
...
class AddPostToCollection extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Add Post to Collection', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        return [
            'success' => true,
            'message' => esc_attr__('Post added to collection successfully', 'dollie'),
            'post_id' => $post_id,
