...
#[Action(
    id: 'voxel_create_new_collection_post',
    label: 'Create New Collection Post',
    since: '1.0.0'
)]
/**
 * NewCollectionPost.
...
class NewCollectionPost extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Create New Collection Post', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        return [
            'success' => true,
            'message' => esc_attr__('Collection created successfully', 'dollie'),
