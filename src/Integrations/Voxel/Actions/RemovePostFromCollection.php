...
#[Action(
    id: 'voxel_remove_post_from_collection',
    label: 'Remove Post from Collection',
    since: '1.0.0'
)]
/**
...
class RemovePostFromCollection extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Remove Post from Collection', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        return [
            'success' => true,
            'message' => esc_attr__('Post removed from collection successfully', 'dollie'),
            'post_id' => $post_id,
