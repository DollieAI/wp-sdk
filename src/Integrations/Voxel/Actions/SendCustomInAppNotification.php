...
#[Action(
    id: 'voxel_send_custom_in_app_notification',
    label: 'Send Custom In App Notification',
    since: '1.0.0'
)]
/**
...
class SendCustomInAppNotification extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Send Custom In App Notification', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        return [
            'success' => true,
            'message' => esc_attr__('Custom In-app notification sent successfully', 'dollie'),
            'user_id' => $user_email,
