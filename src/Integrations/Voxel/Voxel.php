...
namespace Dollie\SDK\Integrations\Voxel;
 ...
 * @since 1.0.0
 */
class Voxel extends BaseIntegration
{
    use SingletonLoader;
    ...
    {
        $this->name = __('Voxel', 'dollie');
        $this->description = __('Voxel is a complete no code solution in a single packageto create WordPress dynamic sites.', 'dollie');
        $this->icon_url = DOLLIE_SDK_URL . 'assets/icons/voxel.svg';
        ...
        return [
            ...
            'description' => [
                ...
                'fields' => [
                    [
                        'key' => 'description',
                        'label' => esc_attr__('Description', 'dollie'),
                        'type' => 'text',
                    ],
                ],
            ],
            'timezone' => [
                ...
                'fields' => [
                    [
                        'key' => 'timezone',
                        'label' => esc_attr__('Timezone', 'dollie'),
                        'type' => 'text',
                    ],
                ],
            ],
            'location' => [
                ...
                'fields' => [
                    [
                        'key' => 'address',
                        'label' => esc_attr__('Address', 'dollie'),
                        'type' => 'text',
                    ],
                    [
                        'key' => 'latitude',
                        'label' => esc_attr__('Latitude', 'dollie'),
                        'type' => 'text',
                    ],
                    [
                        'key' => 'longitude',
                        'label' => esc_attr__('Longitude', 'dollie'),
                        'type' => 'text',
                    ],
                ],
            ],
            ...
            'logo' => [
                ...
                'fields' => [
                    [
                        'key' => 'image_id',
                        'label' => esc_attr__('Image ID', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Provide Image ID', 'dollie'),
            ...
            'gallery' => [
                ...
                'fields' => [
                    [
                        ...
                        'label' => esc_attr__('Image ID', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Provide Image IDs, separated by comma', 'dollie'),
            ...
            'website' => [
                ...
                'fields' => [
                    [
                        'key' => 'website',
                        'label' => esc_attr__('Website URL', 'dollie'),
                        'type' => 'text',
                    ],
                ],
            ],
            'phone-number' => [
                ...
                'fields' => [
                    [
                        'key' => 'phone_number',
                        'label' => esc_attr__('Phone Number', 'dollie'),
                        'type' => 'text',
                    ],
                ],
            ],
            'event-date' => [
                ...
                'fields' => [
                    [
                        ...
                        'label' => esc_attr__('Event Start Date', 'dollie'),
                        'type' => 'text',
                    ],
                    [
                        'key' => 'event_end_date',
                        'label' => esc_attr__('Event End Date', 'dollie'),
                        'type' => 'text',
                    ],
                    [
                        'key' => 'event_frequency',
                        'label' => esc_attr__('Event Frequency', 'dollie'),
                        'type' => 'text',
                    ],
                    [
                        'key' => 'repeat_every',
                        'label' => esc_attr__('Event Unit', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Accepted values: day, week, month, year', 'dollie'),

                    ],
                    [
                        'key' => 'event_until',
                        'label' => esc_attr__('Event Until', 'dollie'),
                        'type' => 'text',
                    ],
                ],
            ],
            'work-hours' => [
                ...
                'fields' => [
                    [
                        'key' => 'work_days',
                        'label' => esc_attr__('Work Days', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Accepted values: mon, tue, wed, thu, fri, sat, sun', 'dollie'),

                    ],
                    [
                        'key' => 'work_hours',
                        'label' => esc_attr__('Work Hours', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Enter value pairs as start and end time, separated by dash. For multiple pairs, use comma separator. Eg. 09:00-17:00, 09:00-12:00', 'dollie'),

                    ],
                    [
                        'key' => 'work_status',
                        'label' => esc_attr__('Work Status', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Accepted values: hours, open, close, appointments_only', 'dollie'),
            ...
            'profile-name' => [
                ...
                'fields' => [
                    [
                        'key' => 'profile_name',
                        'label' => esc_attr__('Profile Name', 'dollie'),
                        'type' => 'text',
                    ],
                ],
            ],
            ...
            'number' => [
                ...
                'fields' => [
                    [
                        'key' => 'number',
                        'label' => esc_attr__('Number', 'dollie'),
                        'type' => 'text',
                    ],
                ],
            ],
            'switcher' => [
                ...
                'fields' => [
                    [
                        'key' => 'switcher',
                        'label' => esc_attr__('Switcher', 'dollie'),
                        'type' => 'yes/no',
                    ],
                ],
            ],
            'texteditor' => [
                ...
                'fields' => [
                    [
                        'key' => 'text_editor',
                        'label' => esc_attr__('Text Editor', 'dollie'),
                        'type' => 'textarea',
                    ],
                ],
            ],
            'taxonomy' => [
                ...
                'fields' => [
                    [
                        'key' => 'taxonomy',
                        'label' => esc_attr__('Taxonomy Slug', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Provide related taxonomy slug(s). If multiples allowed, separate with comma.', 'dollie'),
                    ],
                ],
            ],
            'product' => [
                ...
                'fields' => [
                    [
                        'key' => 'product',
                        'label' => esc_attr__('Product ID', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Provide Product ID', 'dollie'),
            ...
            'image' => [
                ...
                'fields' => [
                    [
                        ...
                        'label' => esc_attr__('Image ID', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Provide Image IDs. Separate with comma.', 'dollie'),
            ...
            'file' => [
                ...
                'fields' => [
                    [
                        'key' => 'file_id',
                        'label' => esc_attr__('File ID', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Provide File ID', 'dollie'),
            ...
            'repeater' => [
                ...
                'fields' => [
                    [
                        'key' => 'repeater',
                        'label' => esc_attr__('Repeater', 'dollie'),
                        'type' => 'repeater',
                    ],
                ],
            ],
            ...
            'post-relation' => [
                ...
                'fields' => [
                    [
                        'key' => 'post_id',
                        'label' => esc_attr__('Post ID', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Provide Post ID', 'dollie'),
            ...
            'select' => [
                ...
                'fields' => [
                    [
                        'key' => 'select',
                        'label' => esc_attr__('Select', 'dollie'),
                        'type' => 'select',
                    ],
                ],
            ],
            ...
            'ui-image' => [
                ...
                'fields' => [
                    [
                        'key' => 'image_id',
                        'label' => esc_attr__('Image IDs', 'dollie'),
                        'type' => 'text',
                        'help' => esc_attr__('Provide Image IDs. Separate with comma.', 'dollie'),
