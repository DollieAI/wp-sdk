...
class CreateTrip extends AutomateAction
{
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (empty($trip_name)) {
            return [
                'status' => 'error',
                'message' => __('Trip name is required.', 'dollie'),
        ...
        if (empty($post_id)) {
            return [
                'status' => 'error',
                'message' => __('Failed to create trip.', 'dollie'),
        ...
        return [
            'status' => 'success',
            'message' => sprintf(__('Trip created with ID %d', 'dollie'), $post_id),
            'trip_id' => $post_id,
        ];
    }
