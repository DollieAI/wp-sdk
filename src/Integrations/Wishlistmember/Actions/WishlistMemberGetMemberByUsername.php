...
#[Action(
    id: 'wishlist_member_get_member_by_username',
    label: 'Get Member By Username',
    since: '1.0.0'
)]
/**
...
class WishlistMemberGetMemberByUsername extends AutomateAction
{
    ...
    public function register($actions)
    {
        ...
        $actions[$this->integration][$this->action] = [
            'label' => __('Get Member By Username', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if ($response) {
            ...
            return [
                'success' => false,
                'msg' => __('No user found for the searched username', 'dollie'),
