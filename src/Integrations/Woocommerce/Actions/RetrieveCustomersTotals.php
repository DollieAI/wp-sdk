...
#[Action(
    id: 'wc_retrieve_customers_totals',
    label: 'Retrieve Customers Totals',
    since: '1.0.0'
)]
/**
...
class RetrieveCustomersTotals extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Retrieve Customers Totals', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! $tables_exist) {
            return [
                'status' => 'error',
                'message' => __('Required WooCommerce tables not found.', 'dollie'),
        ...
        if (0 === $paying && 0 === $non_paying) {
            return [
                'status' => 'error',
                'message' => __('No customers found.', 'dollie'),
