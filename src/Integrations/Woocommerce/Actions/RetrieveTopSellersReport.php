...
#[Action(
    id: 'wc_retrieve_top_sellers_report',
    label: 'Retrieve Top Sellers Report',
    since: '1.0.0'
)]
/**
...
class RetrieveTopSellersReport extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Retrieve Top Sellers Report', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! class_exists('Automattic\\WooCommerce\\Admin\\API\\Reports\\Products\\Query')) {
            return [
                'status' => 'error',
                'message' => __('WooCommerce Admin Reports API not available.', 'dollie'),
