...
#[Action(
    id: 'wc_change_user_membership_plan',
    label: 'Change User Membership Plan',
    since: '1.0.0'
)]
/**
...
class ChangeUserMembershipPlan extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Change User Membership Plan', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! function_exists('wc_memberships_get_user_membership')) {
            return [
                'status' => 'error',
                'message' => __('wc_memberships_get_user_membership function not found.', 'dollie'),
