...
#[Action(
    id: 'wc_create_subscription_order_product',
    label: 'Create a subscription order with a product',
    since: '1.0.0'
)]
/**
...
class CreateSubscriptionOrderProduct extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Create a subscription order with a product', 'dollie'),
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (! class_exists('\WC_Order')) {
            return [
                'status' => 'error',
                'message' => __('\WC_Order class not found.', 'dollie'),
        ...
        if (! class_exists('WC_Subscriptions_Product')) {
            return [
                'status' => 'error',
                'message' => __('WC_Subscriptions_Product class not found.', 'dollie'),
