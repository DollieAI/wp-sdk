...
namespace Dollie\SDK\Integrations\WPJobManager\Triggers;
...
#[Trigger(
    id: 'wpjob_manager_transition_post_status',
    label: 'User publishes a job of a type',
    since: '1.0.0'
)]
/**
 * PublishJob.
...
class PublishJob
{
    ...
    public function register($triggers)
    {
        ...
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('User publishes a job of a type', 'dollie'),
            'action' => $this->trigger,
