...
namespace Dollie\SDK\Integrations\WpPolls;
 ...
 * @since 1.0.0
 */
class WpPolls extends BaseIntegration
{
    use SingletonLoader;
    ...
    {
        $this->name = __('WP-Polls', 'dollie');
        $this->description = __('WP-Polls is a WordPress polls plugin.', 'dollie');
        $this->icon_url = DOLLIE_SDK_URL . 'assets/icons/wppolls.svg';
