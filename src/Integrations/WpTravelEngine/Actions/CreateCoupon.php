...
class CreateCoupon extends AutomateAction
{
    ...
    public function register($actions)
    {
        $actions[$this->integration][$this->action] = [
            'label' => __('Create a Coupon', 'dollie'),
            'description' => __('Create a new coupon for WP Travel Engine', 'dollie'),
            'action' => $this->action,
    ...
    public function _action_listener($user_id, $automation_id, $fields, $selected_options)
    {
        ...
        if (empty($selected_options['coupon_code'])) {
            return [
                'status' => 'error',
                'message' => __('Coupon code is required.', 'dollie'),
