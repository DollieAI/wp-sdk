...
namespace Dollie\SDK\Integrations\Wpforo\Triggers;
...
#[Trigger(
    id: 'user_replies_topic_forum',
    label: 'User Replies to Topic in Forum',
    since: '1.0.0'
)]
/**
...
class UserRepliesTopicForum
{
    ...
    public function register($triggers)
    {
        ...
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('User Replies to Topic in Forum', 'dollie'),
            'action' => $this->trigger,
