...
namespace Dollie\SDK\Integrations\Wployalty\Actions;
...
#[Action(
    id: 'wp_loyalty_remove_points_customer',
    label: 'Remove Points of Customer',
    since: '1.0.0'
)]
/**
...
class WPLoyaltyRemovePointsCustomer extends AutomateAction
{
    ...
    public function register($actions)
    {
        ...
        $actions[$this->integration][$this->action] = [
            'label' => __('Remove Points of Customer', 'dollie'),
            'action' => $this->action,
