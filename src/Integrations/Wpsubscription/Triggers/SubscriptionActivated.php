...
class SubscriptionActivated
{
     ...
     * @var string
     */
    public $trigger = 'wp_subscription_activated';
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('Subscription Activated', 'dollie'),
            'action' => $this->trigger,
            'common_action' => 'subscrpt_subscription_activated',
