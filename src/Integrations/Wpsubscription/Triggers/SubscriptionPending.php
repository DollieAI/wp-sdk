...
class SubscriptionPending
{
     ...
     * @var string
     */
    public $trigger = 'wp_subscription_pending';
    ...
    public function register($triggers)
    {
        $triggers[$this->integration][$this->trigger] = [
            'label' => __('Subscription Pending', 'dollie'),
            'action' => $this->trigger,
            'common_action' => 'subscrpt_subscription_pending',
...
SubscriptionPending::get_instance();
